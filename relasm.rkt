...
(define label-ht-forMERL (make-hash)) ;store all the labels for MERL usage
...
(define add-header (append
 (list (list (token 'id (list #\b #\e #\q)) (token 'register 0) (token 'comma '(#\,)) (token 'register 0) (token 'comma '(#\,)) (token 'int 2))
